<div class="border py-3 pb-2 mt-1">
    ...
    {!! Form::open(['route' => ['posts.search'],'method' => 'GET']) !!}
        ...
        {!! Form::select('place_keyword', ['--','北海道','青森','岩手','宮城','秋田','山形','福島',
        ...
        {!! Form::select('age_keyword', ['--','10代','20代','30代','40代','50代','60代','70代～'],null, ['class' => 'form-control']) !!}
        {!! Form::label('style_keyword', '　宿泊・日帰り') !!}
        {!! Form::select('style_keyword', ['--', '宿泊', '日帰り'],null, ['class' => 'form-control']) !!}
